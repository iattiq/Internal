...
-- Main vars
local Main, Explorer, Properties, ScriptViewer, DefaultSettings, Notebook, Executor, Loadstring, Serializer, Lib
local API, RMD
...
Main = (function()
	...
	Main.ModuleList = {"Explorer","Properties","ScriptViewer", "Executor", "Loadstring"}
	Main.Elevated = false
	Main.MissingEnv = {}
	Main.Version = "Dev 4.0.0"
	Main.Mouse = plr:GetMouse()
	Main.AppControls = {}
	Main.Apps = Apps
	Main.MenuApps = {}
	Main.GitRepoName = "iattiq/Internal"
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Util",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by Nihai",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "X" or "U"
	...
	Main.CreateMainGui = function()
		...
		local mainFrame = openButton.MainFrame
		local bottomFrame = mainFrame.BottomFrame
		
		local settingsButton = bottomFrame.Settings
		local informationButton = bottomFrame.Information
		...
		Main.CreateApp({Name = "Executor", IconMap = Main.LargeIcons, Icon = "Executor", Window = Executor.Window})
	...
	Main.Init = function()
		...
		Main.LargeIcons:SetDict({
			Explorer = 0, Properties = 1, Script_Viewer = 2, Executor = 4,
		})
